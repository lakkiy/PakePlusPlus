...
**PakePlus 是抄袭 [Pake](https://github.com/tw93/Pake) 项目的。** 如果您需要此类功能，建议直接使用原版 [Pake](https://github.com/tw93/Pake) 项目。

**PakePlus is a copy of [Pake](https://github.com/tw93/Pake).** If you are looking for this functionality, we recommend using the original [Pake](https://github.com/tw93/Pake) project instead.
...
- Issue: https://github.com/Sjj1024/PakePlus/issues/9746
- V2EX 吃瓜帖子 / V2EX discussions: 
  - https://v2ex.com/t/1148556
  - https://v2ex.com/t/1148581
  - https://v2ex.com/t/1148647
...
4. When using GitHub Token functionality, you can manually fork the PakePlus repository to your own account if needed for project creation and compilation.
